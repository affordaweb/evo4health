...
import { Calendar, ArrowRight, Phone, MessageSquare, Star, Users, Award } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Ready to Start<br />
              Your <span className="text-gold-400">Health Journey?</span>
            </h2>

            <p className="text-primary-300 text-lg leading-relaxed mb-10 max-w-md">
              No pressure, just a friendly conversation with Erin about your health goals and how functional medicine can help you get there.
            </p>
